...
public class TeamPropProcessor implements VisionProcessor {
    ...
    public static int leftCenterX = 15;
    public static int leftCenterY = 170;
    public static int leftX = 80;
    public static int leftY = 100;
    public static int leftRotation = 0;
    public static int midCenterX = 290;
    public static int midCenterY = 165;
    public static int midX = 80;
    public static int midY = 100;
    public static int midRotation = 0;
    public static int rightCenterX = 570;
    public static int rightCenterY = 160;
